...
public class home_sell_item_var_link {
    ...
    public home_sell_item_var_link(String p_Name, String p_Price, String p_Date_Added, String p_Cover_URL, String p_Product_ID, String p_Photo_Count, String p_Product_Desc){
        prod_Name = p_Name;
        prod_Price = p_Price;
